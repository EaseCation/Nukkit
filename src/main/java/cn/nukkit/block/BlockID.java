...
public interface BlockID {
    ...
    int BLOCK_WOODEN_DOOR = 64; // meta 31
    int LADDER = 65;
    int RAIL = 66;
    int STONE_STAIRS = 67;
    int WALL_SIGN = 68;
    ...
    int BLOCK_IRON_DOOR = 71; // meta 31
    ...
    int BLOCK_SPRUCE_DOOR = 193; // meta 31
    int BLOCK_BIRCH_DOOR = 194; // meta 31
    int BLOCK_JUNGLE_DOOR = 195; // meta 31
    int BLOCK_ACACIA_DOOR = 196; // meta 31
    int BLOCK_DARK_OAK_DOOR = 197; // meta 31
    int GRASS_PATH = 198;
    int BLOCK_FRAME = 199;
