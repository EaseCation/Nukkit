...
public interface BlockID {
     ...
     */
    @Deprecated
    int DOUBLE_STONE_BLOCK_SLAB3 = 422;
    /**
     ...
     */
    @Deprecated
    int DOUBLE_STONE_BLOCK_SLAB4 = 423;
    /**
