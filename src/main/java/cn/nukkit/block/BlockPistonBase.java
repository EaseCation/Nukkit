            ...
            for (Block newBlock : newBlocks) {
                ...
                CompoundTag nbt = BlockEntity.getDefaultCompound(newBlock, BlockEntity.MOVING_BLOCK)
                        ...
                        .putCompound("movingBlock", new CompoundTag()
                                ...
                                .putString("name", GlobalBlockPalette.getNameByRuntimeId(GlobalBlockPalette.getOrCreateRuntimeId(newBlock.getId(), newBlock.getDamage()))) //先获取runtimeId
                        );
        ...
        private final List<Block> toMove = new ArrayList<Block>() {
            ...
            public int indexOf(Object o) {
                if (o == null) {
                    ...
                    for (int i = 0; i < size(); i++) {
                        Block block = get(i);
                        if (o instanceof Block) { //TODO: (ec) Block::equals被重写了
