...
public interface ProtocolInfo {
    ...
    int PRIMITIVE_SHAPES_PACKET = 0x148; // 328 c
    int SERVERBOUND_PACK_SETTING_CHANGE_PACKET = 0x149; // 329 s
    int CLIENTBOUND_DATA_STORE_PACKET = 0x14a; // 330 c
    int GRAPHICS_OVERRIDE_PARAMETER_PACKET = 0x14b; // 331 c
    int SERVERBOUND_DATA_STORE_PACKET = 0x14c; // 332 s
    int CLIENTBOUND_DATA_DRIVEN_UI_SHOW_SCREEN_PACKET = 0x14d; // 333 c
    int CLIENTBOUND_DATA_DRIVEN_UI_CLOSE_SCREEN_PACKET = 0x14e; // 334 c
    int CLIENTBOUND_DATA_DRIVEN_UI_RELOAD_PACKET = 0x14f; // 335 c
    int CLIENTBOUND_TEXTURE_SHIFT_PACKET = 0x150; // 336 c
    int VOXEL_SHAPES_PACKET = 0x151; // 337 c
    int CAMERA_SPLINE_PACKET = 0x152; // 338 c
    int CAMERA_AIM_ASSIST_ENTITY_PRIORITY_PACKET = 0x153; // 339 c
    int RESOURCE_PACKS_READY_FOR_VALIDATION_PACKET = 0x154; // 340 s
    int LOCATOR_BAR_PACKET = 0x155; // 341 c
    int PARTY_CHANGED_PACKET = 0x156; // 342 s
    int SERVERBOUND_DATA_DRIVEN_SCREEN_CLOSED_PACKET = 0x157; // 343 s
    int SYNC_WORLD_CLOCKS_PACKET = 0x158; // 344 c
    int CLIENTBOUND_ATTRIBUTE_LAYER_SYNC_PACKET = 0x159; // 345 c
    int SERVER_STORE_INFO_PACKET = 0x15a; // 346 c
    int SERVER_PRESENCE_INFO_PACKET = 0x15b; // 347 c
    int CLIENTBOUND_UPDATE_SOUND_DATA_PACKET = 0x15c; // 348 c
    int SEND_PARTY_DESTINATION_COOKIE_PACKET = 0x15d; // 349 s
    int PARTY_DESTINATION_COOKIE_RESPONSE_PACKET = 0x15e; // 350 c
