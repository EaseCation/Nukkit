...
public enum ParticleEffect {
    ...
    BIOME_TINTED_LEAVES_PARTICLE("minecraft:biome_tinted_leaves_particle"),
    ...
    BREEZE_WIND_EXPLOSION("minecraft:breeze_wind_explosion_emitter"),
    ...
    CREAKING_CRUMBLE_BODY("minecraft:creaking_crumble_body"),
    CREAKING_CRUMBLE_HEAD("minecraft:creaking_crumble_head"),
    CREAKING_HEART_TRAIL("minecraft:creaking_heart_trail"),
    ...
    FIREFLY_PARTICLE("minecraft:firefly_particle"),
    FISH_HOOK("minecraft:fish_hook_particle"),
    FISH_POS("minecraft:fish_pos_particle"),
    GEYSER_BASE_PARTICLE("minecraft:geyser_base"),
    GEYSER_PLUME_PARTICLE("minecraft:geyser_plume"),
    GEYSER_POOF_PARTICLE("minecraft:geyser_poof"),
    ...
    MOBSPELL_LINGERING("minecraft:mobspell_lingering"),
    ...
    NAUTILUS_BUBBLES("minecraft:nautilus_bubbles_particle"),
    NECTAR_DRIP("minecraft:nectar_drip_particle"),
    NOTE("minecraft:note_particle"),
    NOXIOUS_GAS_PARTICLE("minecraft:noxious_gas_particle"),
    ...
    SMALL_FLAME("minecraft:small_flame_particle"),
    ...
    SULFUR_BUBBLE_PARTICLE("minecraft:sulfur_bubble_particle"),
    SULFUR_CUBE_PARTICLE("minecraft:sulfur_cube_goo"),
    ...
    TRIAL_SPAWNER_DETECTION_PARTICLE("minecraft:trial_spawner_detection"),
    TRIAL_SPAWNER_DETECTION_OMINOUS_PARTICLE("minecraft:trial_spawner_detection_ominous"),
