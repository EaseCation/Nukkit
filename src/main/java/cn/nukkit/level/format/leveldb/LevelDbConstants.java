...
public final class LevelDbConstants {
    ...
    public static final byte[] FINALISATION_GENERATION_SAVE_DATA = new byte[]{FINALISATION_NEEDS_INSTATICKING, 0, 0, 0}; // intLE
    public static final byte[] FINALISATION_POPULATION_SAVE_DATA = new byte[]{FINALISATION_NEEDS_POPULATION, 0, 0, 0};
    public static final byte[] FINALISATION_DONE_SAVE_DATA = new byte[]{FINALISATION_DONE, 0, 0, 0};
