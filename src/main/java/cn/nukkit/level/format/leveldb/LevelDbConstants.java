...
public final class LevelDbConstants {
    ...
    public static final byte CURRENT_ENTITY_DIGEST_VERSION = 0; // 1.18.30
    ...
    private static final byte LATEST_ENTITY_DIGEST_VERSION = 0; // 1.18.30
    ...
    public static final byte[] BLENDING_DATA_SAVE_DATA = new byte[]{0, 8};
    public static final byte[] ENTITY_DIGEST_VERSION_SAVE_DATA = new byte[]{CURRENT_ENTITY_DIGEST_VERSION};
