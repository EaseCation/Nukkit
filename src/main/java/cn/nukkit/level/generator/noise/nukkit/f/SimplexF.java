...
public class SimplexF extends PerlinF {
    ...
    public SimplexF(RandomSource random, float octaves, float persistence) {
        super(random, octaves, persistence);
        this.offsetW = random.nextFloat() * 256;
    }

    public SimplexF(RandomSource random, float octaves, float persistence, float expansion) {
