 ...
 * @author PikyCZ
 */
public class EntityLlama extends EntityAnimal implements EntityInteractable, EntityRideable, InventoryHolder {

    public static final int NETWORK_ID = EntityID.LLAMA;

    public static final int LLAMA_VARIANT_CREAMY = 0;
    public static final int LLAMA_VARIANT_WHITE = 1;
    public static final int LLAMA_VARIANT_BROWN = 2;
    public static final int LLAMA_VARIANT_GRAY = 3;

    public static final int LLAMA_MARK_DEFAULT = 0;
    public static final int LLAMA_MARK_TRADER = 1;
    ...
    public void initEntity() {
        ...
        dataProperties.putInt(DATA_MARK_VARIANT, namedTag.getInt("MarkVariant", LLAMA_MARK_DEFAULT));
    ...
    public boolean onInteract(Player player, Item item) {
        ...
        if (getDataFlag(DATA_FLAG_TAMED)) {
            ...
            if (item.is(ItemBlockID.CARPET) && inventory.getItem(0).isNull()) {
                ...
                level.addLevelSoundEvent(this, LevelSoundEventPacket.SOUND_ARMOR_EQUIP_GENERIC, EntityFullNames.LLAMA);
                return true;
            }
        }
