...
public interface EntityPropertyStringValues {
    String ARMADILLO_STATE_ROLLED_UP = "rolled_up";
    String ARMADILLO_STATE_ROLLED_UP_PEEKING = "rolled_up_peeking";
    String ARMADILLO_STATE_ROLLED_UP_RELAXING = "rolled_up_relaxing";
    ...
    String CREAKING_STATE_CRUMBLING = "crumbling";
    String CREAKING_STATE_HOSTILE_OBSERVED = "hostile_observed";
    ...
    String SOUND_VARIANT_DEFAULT = "default";
    String SOUND_VARIANT_GRUMPY = "grumpy";
    String SOUND_VARIANT_MAD = "mad";
    String SOUND_VARIANT_MINI = "mini";
    String SOUND_VARIANT_MOODY = "moody";
    String SOUND_VARIANT_PICKY = "picky";
