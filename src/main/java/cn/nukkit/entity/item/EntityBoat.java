...
//                    this.motionY = this.motionY + SINKING_SPEED > SINKING_MAX_SPEED ? this.motionY - SINKING_SPEED : this.motionY + SINKING_SPEED;
    ...
    public boolean mountEntity(Entity entity) {
        ...
        if (entity.riding != null) {
            ...
            entity.setDataProperty(new FloatEntityData(DATA_SEAT_LOCK_RIDER_ROTATION_DEGREES, 90));

            entity.setDataProperty(new FloatEntityData(DATA_SEAT_ROTATION_OFFSET, this.passengers.indexOf(entity) == 1 ? -90 : 0));
