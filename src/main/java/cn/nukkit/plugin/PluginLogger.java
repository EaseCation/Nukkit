 ...
 * Nukkit Project
 */
public final class PluginLogger implements Logger, cn.nukkit.utils.Logger {
    ...
    public void emergency(String message) {
        ...
        logger.error(this.pluginName + message);
    }

    @Override
    public void alert(String message) {
        //this.log(LogLevel.ALERT, message);
        logger.warn(this.pluginName + message);
    }
    ...
    public void emergency(String message, Throwable t) {
        ...
        this.logger.error(this.pluginName + message, t);
    }

    @Override
    public void alert(String message, Throwable t) {
        //this.log(LogLevel.ALERT, message, t);
        this.logger.warn(this.pluginName + message, t);
    }
